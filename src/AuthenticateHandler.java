...
public class AuthenticateHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            boolean success = enroll.authenticate(imagePath);
            String response = success ? "{\"message\":\"Authenticated successfully\"}" : "{\"error\":\"Authentication failed\"}";
            Main.sendJsonResponse(exchange, success ? 200 : 401, response);
        } catch (Exception e) {
